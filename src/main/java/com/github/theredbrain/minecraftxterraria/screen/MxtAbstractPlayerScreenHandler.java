...
//
//public abstract class MxtAbstractPlayerScreenHandler extends ScreenHandler {
...
//
//    public MxtAbstractPlayerScreenHandler(MxtPlayerInventory mxtPlayerInventory, boolean onServer, final PlayerEntity owner) {
//        super(null, 0);
////        int i;
////        int j;
...
////                this.addSlot(new Slot(mxtPlayerInventory, 109 + j * 10 + i, xGearInventoryOffset + 8, yGearInventoryOffset + 8 + i * 18) {
////
////                    @Override
////                    public boolean isEnabled() {
...
////                this.addSlot(new Slot(mxtPlayerInventory, 139 + j * 10 + i, xGearInventoryOffset + 28, yGearInventoryOffset + 8 + i * 18) {
////
////                    @Override
////                    public boolean isEnabled() {
////                        return activeGearInventory == loadout + 1;
...
////                this.addSlot(new Slot(mxtPlayerInventory, 169 + j * 10 + i, xGearInventoryOffset + 48, yGearInventoryOffset + 8 + i * 18) {
////
////                    @Override
////                    public boolean isEnabled() {
////                        return activeGearInventory == loadout + 1;
...
////                this.addSlot(new Slot(mxtPlayerInventory, 112 + j * 10 + i, xGearInventoryOffset + 8, yGearInventoryOffset + 66 + i * 18) {
////
////                    @Override
////                    public boolean isEnabled() {
////                        return activeGearInventory == loadout + 1;
...
////                this.addSlot(new Slot(mxtPlayerInventory, 142 + j * 10 + i, xGearInventoryOffset + 28, yGearInventoryOffset + 66 + i * 18) {
////
////                    @Override
////                    public boolean isEnabled() {
////                        return activeGearInventory == loadout + 1;
...
////                this.addSlot(new Slot(mxtPlayerInventory, 172 + j * 10 + i, xGearInventoryOffset + 48, yGearInventoryOffset + 66 + i * 18) {
////
////                    @Override
////                    public boolean isEnabled() {
////                        return activeGearInventory == loadout + 1;
...
//        super.close(player);
////        this.craftingResult.clear(); // TODO?
//        if (player.world.isClient) {
//            return;
//        }
////        this.dropInventory(player, this.);
//    }
//
//    @Override
