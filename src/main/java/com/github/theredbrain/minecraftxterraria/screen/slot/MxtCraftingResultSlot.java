package com.github.theredbrain.minecraftxterraria.screen.slot;
...
public class MxtCraftingResultSlot extends Slot {
    private final PlayerInventory input;
    private final PlayerEntity player;
    private int amount;

    public MxtCraftingResultSlot(PlayerEntity player, PlayerInventory input, Inventory inventory, int index, int x, int y) {
...
/*
    @Override
    public void onTakeItem(PlayerEntity player, ItemStack stack) { // TODO
        this.onCrafted(stack);
