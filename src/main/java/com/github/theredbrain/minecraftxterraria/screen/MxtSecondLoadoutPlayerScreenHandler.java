...
//
//public class MxtSecondLoadoutPlayerScreenHandler extends MxtAbstractPlayerScreenHandler {
//    public MxtSecondLoadoutPlayerScreenHandler(MxtPlayerInventory mxtPlayerInventory, boolean onServer, PlayerEntity owner) {
...
//                this.addSlot(new Slot(mxtPlayerInventory, 119 + i, xGearInventoryOffset + 8, yGearInventoryOffset + 8 + i * 18) {
//
////                    @Override
////                    public boolean isEnabled() {
...
//                this.addSlot(new Slot(mxtPlayerInventory, 149 + i, xGearInventoryOffset + 28, yGearInventoryOffset + 8 + i * 18) {
//
////                    @Override
////                    public boolean isEnabled() {
////                        return activeGearInventory == loadout + 1;
...
//                this.addSlot(new Slot(mxtPlayerInventory, 179 + i, xGearInventoryOffset + 48, yGearInventoryOffset + 8 + i * 18) {
//
////                    @Override
////                    public boolean isEnabled() {
////                        return activeGearInventory == loadout + 1;
...
//                this.addSlot(new Slot(mxtPlayerInventory, 122 + i, xGearInventoryOffset + 8, yGearInventoryOffset + 66 + i * 18) {
//
////                    @Override
////                    public boolean isEnabled() {
////                        return activeGearInventory == loadout + 1;
...
//                this.addSlot(new Slot(mxtPlayerInventory, 152 + i, xGearInventoryOffset + 28, yGearInventoryOffset + 66 + i * 18) {
//
////                    @Override
////                    public boolean isEnabled() {
////                        return activeGearInventory == loadout + 1;
...
//                this.addSlot(new Slot(mxtPlayerInventory, 182 + i, xGearInventoryOffset + 48, yGearInventoryOffset + 66 + i * 18) {
//
////                    @Override
////                    public boolean isEnabled() {
////                        return activeGearInventory == loadout + 1;
