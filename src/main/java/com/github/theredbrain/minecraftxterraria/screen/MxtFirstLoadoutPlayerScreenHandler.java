...
//
//public class MxtFirstLoadoutPlayerScreenHandler extends MxtAbstractPlayerScreenHandler {
//    public MxtFirstLoadoutPlayerScreenHandler(MxtPlayerInventory mxtPlayerInventory, boolean onServer, PlayerEntity owner) {
...
//                this.addSlot(new Slot(mxtPlayerInventory, 109 + i, xGearInventoryOffset + 8, yGearInventoryOffset + 8 + i * 18) {
//
////                    @Override
////                    public boolean isEnabled() {
...
//                this.addSlot(new Slot(mxtPlayerInventory, 139 + i, xGearInventoryOffset + 28, yGearInventoryOffset + 8 + i * 18) {
//
////                    @Override
////                    public boolean isEnabled() {
////                        return activeGearInventory == loadout + 1;
...
//                this.addSlot(new Slot(mxtPlayerInventory, 169 + i, xGearInventoryOffset + 48, yGearInventoryOffset + 8 + i * 18) {
//
////                    @Override
////                    public boolean isEnabled() {
////                        return activeGearInventory == loadout + 1;
...
//                this.addSlot(new Slot(mxtPlayerInventory, 112 + i, xGearInventoryOffset + 8, yGearInventoryOffset + 66 + i * 18) {
//
////                    @Override
////                    public boolean isEnabled() {
////                        return activeGearInventory == loadout + 1;
...
//                this.addSlot(new Slot(mxtPlayerInventory, 142 + i, xGearInventoryOffset + 28, yGearInventoryOffset + 66 + i * 18) {
//
////                    @Override
////                    public boolean isEnabled() {
////                        return activeGearInventory == loadout + 1;
...
//                this.addSlot(new Slot(mxtPlayerInventory, 172 + i, xGearInventoryOffset + 48, yGearInventoryOffset + 66 + i * 18) {
//
////                    @Override
////                    public boolean isEnabled() {
////                        return activeGearInventory == loadout + 1;
