...
public class MxTChainsawItem extends MxtToolItem implements IMxTAxePower {
    int axePower;
    public MxTChainsawItem(Settings settings, int baseRarity, int researchAmount, int sellPrice, boolean autoSwing, int useTime, int attackDamage, int bonus, int criticalChance, double knockback, @Nullable Pair<StatusEffectInstance, Float> statusEffect, int miningSpeed, int axePower) {
