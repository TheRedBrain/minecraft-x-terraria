...
public class MxTHammerAxeItem extends MxtToolItem implements IMxTAxePower, IMxTHammerPower {
    int axePower;
    int hammerPower;
    public MxTHammerAxeItem(Settings settings, int baseRarity, int researchAmount, int sellPrice, boolean autoSwing, int useTime, int attackDamage, int bonus, int criticalChance, double knockback, @Nullable Pair<StatusEffectInstance, Float> statusEffect, int miningSpeed, int axePower, int hammerPower) {
