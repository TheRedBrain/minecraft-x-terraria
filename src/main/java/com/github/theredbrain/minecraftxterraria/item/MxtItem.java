...
public class MxtItem extends Item {
    int baseRarity;
    int researchAmount;
    int sellPrice;
    public MxtItem(Settings settings, int baseRarity, int researchAmount, int sellPrice) {
        super(settings);
    ...
    public Text getName(ItemStack stack) {
        ...
        int finalRarity = this.baseRarity + modifierRarity;
