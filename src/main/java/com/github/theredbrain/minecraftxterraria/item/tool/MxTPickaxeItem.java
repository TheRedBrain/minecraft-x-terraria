...
public class MxTPickaxeItem extends AbstractMxTToolItem implements IMxTPickaxePower {
    int pickaxePower;
    public MxTPickaxeItem(Settings settings, int attackDamage, int criticalChance, int bonus, int useTime, int miningSpeed, int knockback, int baseRarity, int sellPrice, int researchAmount, @Nullable Pair<StatusEffectInstance, Float> statusEffect, int pickaxePower) {
