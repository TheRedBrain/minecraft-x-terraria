...
public class MxTAxeItem extends AbstractMxTToolItem implements IMxTAxePower {
    int axePower;
    public MxTAxeItem(Settings settings, int attackDamage, int criticalChance, int bonus, int useTime, int miningSpeed, int knockback, int baseRarity, int sellPrice, int researchAmount, @Nullable Pair<StatusEffectInstance, Float> statusEffect, int axePower) {
