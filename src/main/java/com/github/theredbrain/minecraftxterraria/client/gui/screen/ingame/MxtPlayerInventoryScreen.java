...
public class MxtPlayerInventoryScreen  extends MxtHandledScreen<MxtPlayerInventoryScreenHandler> {
...
//    private boolean mouseDown;
    ...
    public MxtPlayerInventoryScreen(PlayerEntity owner) {
        super(((DuckPlayerEntityMixin)owner).getMxtPlayerInventoryScreenHandler(), Text.translatable("container.inventory"));
        this.owner = owner;
...
//        this.recipeBook.update();
    ...
    protected void init() {
        ...
        this.x_equipment_inventory_offset = ((DuckPlayerEntityMixin)owner).getMxtPlayerInventory().getXEquipmentInventoryOffset();
        this.y_equipment_inventory_offset = ((DuckPlayerEntityMixin)owner).getMxtPlayerInventory().getYEquipmentInventoryOffset();
    }
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        // inactive tabs
        if (((DuckPlayerEntityMixin)this.owner).getActiveInventoryTab() == 2) {
        ...
        } else if (((DuckPlayerEntityMixin)this.owner).getActiveInventoryTab() == 1) {
            ...
            if (((DuckPlayerEntityMixin)this.owner).getActiveLoadout() == 2) {
            ...
            } else if (((DuckPlayerEntityMixin)this.owner).getActiveLoadout() == 1) {
                // inactive loadout 0 tab
                this.drawTexture(matrices, this.x_main_inventory + this.x_gear_inventory_offset + this.loadoutInventoryBackgroundWidth - 3, this.y_main_inventory + this.y_gear_inventory_offset, 0, 110, 32, 26);
        ...
        if (((DuckPlayerEntityMixin)this.owner).getActiveInventoryTab() == 2) {
            ...
            RenderSystem.setShaderColor(1.0f, 1.0f, 1.0f, 1.0f);
            RenderSystem.setShaderTexture(0, EQUIPMENT_INVENTORY_BACKGROUND_TEXTURE);
            this.drawTexture(matrices, this.x_main_inventory + this.x_equipment_inventory_offset, this.y_main_inventory + this.y_equipment_inventory_offset, 0, 0, this.equipmentInventoryBackgroundWidth, this.equipmentInventoryBackgroundHeight);
        } else { // TODO journey mode
            if ((((DuckPlayerEntityMixin) this.owner).mxtGetDemonHeartConsumed()) && this.owner.world.getDifficulty() == Difficulty.HARD) {
                RenderSystem.setShader(GameRenderer::getPositionTexProgram);
                RenderSystem.setShaderColor(1.0f, 1.0f, 1.0f, 1.0f);
            ...
            } else if (((this.owner.world.getDifficulty() == Difficulty.NORMAL || this.owner.world.getDifficulty() == Difficulty.HARD) && (((DuckPlayerEntityMixin) this.owner).mxtGetDemonHeartConsumed())) || this.owner.world.getDifficulty() == Difficulty.HARD) {
                RenderSystem.setShader(GameRenderer::getPositionTexProgram);
                RenderSystem.setShaderColor(1.0f, 1.0f, 1.0f, 1.0f);
                RenderSystem.setShaderTexture(0, LOADOUT_INVENTORY_7_SIZE_6_BACKGROUND_TEXTURE);
                this.drawTexture(matrices, this.x_main_inventory + this.x_gear_inventory_offset, this.y_main_inventory + this.y_gear_inventory_offset, 0, 0, this.loadoutInventoryBackgroundWidth, this.loadoutInventory7BackgroundHeight);
            } else {
                RenderSystem.setShader(GameRenderer::getPositionTexProgram);
                RenderSystem.setShaderColor(1.0f, 1.0f, 1.0f, 1.0f);
                RenderSystem.setShaderTexture(0, LOADOUT_INVENTORY_7_SIZE_5_BACKGROUND_TEXTURE);
                this.drawTexture(matrices, this.x_main_inventory + this.x_gear_inventory_offset, this.y_main_inventory + this.y_gear_inventory_offset, 0, 0, this.loadoutInventoryBackgroundWidth, this.loadoutInventory7BackgroundHeight);
            }
        }
...
//                if (((DuckPlayerEntityMixin)this.owner).getActiveInventoryTab() == 2) {
//                    ((DuckPlayerEntityMixin) this.owner).setActiveInventoryTab(0);
//                } else {
//                    ((DuckPlayerEntityMixin) this.owner).setActiveInventoryTab(2);
//                }
//                return true;
//            }
            if (this.isEquipmentTab(mouseX, mouseY)) {
                if (((DuckPlayerEntityMixin)this.owner).getActiveInventoryTab() == 1) {
                    ((DuckPlayerEntityMixin) this.owner).setActiveInventoryTab(0);
//                    ((DuckPlayerEntityMixin) this.owner).getMxtPlayerScreenHandler().setActiveGearInventory(((DuckPlayerEntityMixin) this.owner).getActiveLoadout() + 1);
                } else {
                    ((DuckPlayerEntityMixin) this.owner).setActiveInventoryTab(1);
...
//                this.client.setScreen(((DuckPlayerEntityMixin) this.owner).mxtGetCurrentPlayerInventoryScreen());
            ...
            if (this.isLoadout1Tab(mouseX, mouseY)) {
                ((DuckPlayerEntityMixin)this.owner).setActiveInventoryTab(0);
                ((DuckPlayerEntityMixin)this.owner).setActiveLoadout(0);
//                ((DuckPlayerEntityMixin) this.owner).getMxtPlayerScreenHandler().setActiveGearInventory(((DuckPlayerEntityMixin) this.owner).getActiveLoadout() + 1);
//                this.client.setScreen(((DuckPlayerEntityMixin) this.owner).mxtGetCurrentPlayerInventoryScreen());
//                this.owner.currentScreenHandler = ((DuckPlayerEntityMixin) this.owner).getMxtFirstLoadoutPlayerScreenHandler();
                return true;
            ...
            if (this.isLoadout2Tab(mouseX, mouseY)) {
                ((DuckPlayerEntityMixin)this.owner).setActiveInventoryTab(0);
                ((DuckPlayerEntityMixin)this.owner).setActiveLoadout(1);
//                ((DuckPlayerEntityMixin) this.owner).getMxtPlayerScreenHandler().setActiveGearInventory(((DuckPlayerEntityMixin) this.owner).getActiveLoadout() + 1);
//                this.client.setScreen(((DuckPlayerEntityMixin) this.owner).mxtGetCurrentPlayerInventoryScreen());
//                this.owner.currentScreenHandler = ((DuckPlayerEntityMixin) this.owner).getMxtSecondLoadoutPlayerScreenHandler();
                return true;
            ...
            if (this.isLoadout3Tab(mouseX, mouseY)) {
                ((DuckPlayerEntityMixin)this.owner).setActiveInventoryTab(0);
                ((DuckPlayerEntityMixin)this.owner).setActiveLoadout(2);
//                ((DuckPlayerEntityMixin) this.owner).getMxtPlayerScreenHandler().setActiveGearInventory(((DuckPlayerEntityMixin) this.owner).getActiveLoadout() + 1);
//                this.client.setScreen(((DuckPlayerEntityMixin) this.owner).mxtGetCurrentPlayerInventoryScreen());
//                this.owner.currentScreenHandler = ((DuckPlayerEntityMixin) this.owner).getMxtThirdLoadoutPlayerScreenHandler();
                return true;
...
//        boolean outsideGearInventory = mouseX < (double)(left + this.x_gear_inventory_offset) || mouseY < (double)(top + this.y_gear_inventory_offset) || mouseX >= (double)(left + this.x_gear_inventory_offset + (((DuckPlayerEntityMixin)this.owner).getActiveInventoryTab() == 0 ? this.loadoutInventoryBackgroundWidth : this.equipmentInventoryBackgroundWidth)) || mouseY >= (double)(top + this.x_gear_inventory_offset + (((DuckPlayerEntityMixin)this.owner).getActiveInventoryTab() == 0 ? this.loadoutInventoryBackgroundWidth : this.equipmentInventoryBackgroundHeight));
//        boolean outsideGearInventory = mouseX < (double)(left + this.x_gear_inventory_offset) || mouseY < (double)(top + this.y_gear_inventory_offset) || mouseX >= (double)(left + this.x_gear_inventory_offset + this.loadoutInventoryBackgroundWidth) || mouseY >= (double)(top + this.y_gear_inventory_offset + this.loadoutInventoryBackgroundWidth);
//        boolean outsideEquipmentInventory = mouseX < (double)(left + this.x_equipment_inventory_offset) || mouseY < (double)(top + this.y_equipment_inventory_offset) || mouseX >= (double)(left + this.x_equipment_inventory_offset + this.equipmentInventoryBackgroundWidth) || mouseY >= (double)(top + this.y_equipment_inventory_offset + this.equipmentInventoryBackgroundHeight);
        return outsideMainInventory && !isTrashSlot(mouseX, mouseY) && !isGearInventory(mouseX, mouseY) && !isHousingTab(mouseX, mouseY) && !isEquipmentTab(mouseX, mouseY) && !isLoadout1Tab(mouseX, mouseY) && !isLoadout2Tab(mouseX, mouseY) && !isLoadout3Tab(mouseX, mouseY);
    }

//    private boolean isMainInventory(double mouseX, double mouseY) {
//        return this.isPointWithinBounds(0, 0, 32, 22, mouseX, mouseY);
//    }
...
//    private boolean isEquipmentInventory(double mouseX, double mouseY) {
//        return this.isPointWithinBounds(this.x_equipment_inventory_offset, this.y_equipment_inventory_offset, this.equipmentInventoryBackgroundWidth, this.equipmentInventoryBackgroundHeight, mouseX, mouseY);
//    }

    private boolean isGearInventory(double mouseX, double mouseY) {
        boolean bl = ((DuckPlayerEntityMixin)this.owner).getActiveInventoryTab() == 0;
        return bl ? this.isPointWithinBounds(this.x_gear_inventory_offset, this.y_gear_inventory_offset, this.loadoutInventoryBackgroundWidth, this.loadoutInventory7BackgroundHeight, mouseX, mouseY)
                : this.isPointWithinBounds(this.x_equipment_inventory_offset, this.y_equipment_inventory_offset, this.equipmentInventoryBackgroundWidth, this.equipmentInventoryBackgroundHeight, mouseX, mouseY);
    }

    private boolean isHousingTab(double mouseX, double mouseY) {
        boolean bl = ((DuckPlayerEntityMixin)this.owner).getActiveInventoryTab() == 2;
    ...
    private boolean isEquipmentTab(double mouseX, double mouseY) {
        boolean bl = ((DuckPlayerEntityMixin)this.owner).getActiveInventoryTab() == 1;
    ...
    private boolean isLoadout1Tab(double mouseX, double mouseY) {
        boolean bl = ((DuckPlayerEntityMixin)this.owner).getActiveLoadout() == 0;
        return ((DuckPlayerEntityMixin)this.owner).getActiveInventoryTab() == 0 && this.isPointWithinBounds(this.x_gear_inventory_offset + this.loadoutInventoryBackgroundWidth, this.y_gear_inventory_offset, bl ? 33 : 29, 26, mouseX, mouseY);
    }

    private boolean isLoadout2Tab(double mouseX, double mouseY) {
        boolean bl = ((DuckPlayerEntityMixin)this.owner).getActiveLoadout() == 1;
        return ((DuckPlayerEntityMixin)this.owner).getActiveInventoryTab() == 0 && this.isPointWithinBounds(this.x_gear_inventory_offset + this.loadoutInventoryBackgroundWidth, this.y_gear_inventory_offset + 26, bl ? 33 : 29, 26, mouseX, mouseY);
    }

    private boolean isLoadout3Tab(double mouseX, double mouseY) {
        boolean bl = ((DuckPlayerEntityMixin)this.owner).getActiveLoadout() == 2;
        return ((DuckPlayerEntityMixin)this.owner).getActiveInventoryTab() == 0 && this.isPointWithinBounds(this.x_gear_inventory_offset + this.loadoutInventoryBackgroundWidth, this.y_gear_inventory_offset + 52, bl ? 33 : 29, 26, mouseX, mouseY);
    }
