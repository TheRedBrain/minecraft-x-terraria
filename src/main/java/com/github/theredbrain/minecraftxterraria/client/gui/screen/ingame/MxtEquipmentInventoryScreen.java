...
//import com.github.theredbrain.minecraftxterraria.screen.MxtAbstractPlayerScreenHandler;
...
//public class MxtEquipmentInventoryScreen extends MxtHandledScreen<MxtEquipmentPlayerScreenHandler> {
...
//
//    public MxtEquipmentInventoryScreen(PlayerEntity owner) {
//        super(((DuckPlayerEntityMixin)owner).getMxtEquipmentPlayerScreenHandler(), ((DuckPlayerEntityMixin)owner).getMxtPlayerInventory(), Text.translatable("container.inventory"));
//        this.owner = owner;
