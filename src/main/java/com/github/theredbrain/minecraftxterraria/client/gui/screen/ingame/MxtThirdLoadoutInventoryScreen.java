...
//import com.github.theredbrain.minecraftxterraria.screen.MxtThirdLoadoutPlayerScreenHandler;
...
//public class MxtThirdLoadoutInventoryScreen  extends MxtHandledScreen<MxtPlayerInventoryScreenHandler> {
...
//
//    public MxtThirdLoadoutInventoryScreen(PlayerEntity owner) {
//        super(((DuckPlayerEntityMixin)owner).getMxtPlayerInventoryScreenHandler(), ((DuckPlayerEntityMixin)owner).getMxtPlayerInventory(), Text.translatable("container.inventory"));
//        this.owner = owner;
