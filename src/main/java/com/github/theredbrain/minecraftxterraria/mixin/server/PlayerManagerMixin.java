package com.github.theredbrain.minecraftxterraria.mixin.server;
...
public class PlayerManagerMixin {
    ...
    public void sendPlayerStatus(ServerPlayerEntity player) {
        ((DuckPlayerEntityMixin)player).getMxtPlayerInventoryScreenHandler().syncState();
        player.markHealthDirty();
        player.networkHandler.sendPacket(new UpdateSelectedSlotS2CPacket(((DuckPlayerEntityMixin)player).getMxtPlayerInventory().selectedSlot));
    }
}
